...
public class EffectLayer : MonoBehaviour
{
    ...
    public DIRECTION_TYPE DirType = DIRECTION_TYPE.One;
    ...
    protected void Init()
    {
        ...
        for (int i = 0; i < MaxENodes; i++)
        {
            ...
            else if (RenderType == 1)
            {
                ...
                n.SetType(ConeSize,ConeSegment,ConeAngle, Vector3.up,0,MaxFps,UseConeAngleChange,ConeDeltaAngle);
            AvailableENodes[i] = n;
        }
    ...
    public void SetArractionAffectorGoal(Transform goal)
    {
        ...
        {
            Debug.LogWarning(gameObject.name + "has not attraction affector, please check it");
            return;
        }
