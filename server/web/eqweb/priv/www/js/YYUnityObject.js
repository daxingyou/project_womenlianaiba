...
var unityObject = function() {
	...
	baseUrl = "http://cdn.love.eq.cn/WebPlayer/",
	fullInstall = true,
	autoInstall = false,
	enableJava = true,
		...
		if (re) {
			...
			if (ua.win && ua.ie) {
				...
				if (fullSizeMissing) {
					...
					re.outerHTML = '<div id="yyclickoncebg"><div id="' + id + '" style="width: ' + appendPX(width) + '; height: ' + appendPX(height) + '; text-align: center;' + st + '">' + ft + '</div></div>';
				}
				else {
