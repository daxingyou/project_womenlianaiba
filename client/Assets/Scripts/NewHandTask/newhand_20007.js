...
function RegistEvt(){
	EventCenter.RegistHandler(GameEvent.MakeEvent(GameEventDef.CLICK_AUTO_FITMENT_BTN), HandleClickAutoFitmentBtn);	
...
function HandleClickAutoFitmentBtn(evt : GameEvent, obj : Object){
...
function UnRegistEvt(){
	...
	EventCenter.UnregistHandler(GameEvent.MakeEvent(GameEventDef.CLICK_AUTO_FITMENT_BTN), HandleClickAutoFitmentBtn);	
}
