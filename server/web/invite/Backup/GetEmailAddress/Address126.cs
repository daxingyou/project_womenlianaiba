namespace GetEmailAddress
{
    ...
    public class Address126
    {
        ...
        private Match m;
        private const string mail126 = "http://reg.163.com/login.jsp?type=1&product=mail126&url=http://entry.mail.126.com/cgi/ntesdoor?hid%3D10010102%26lightweight%3D1%26verifycookie%3D1%26language%3D0%26style%3D-1";
        ...
        public Address126(string name, string pwd, Address163.Entrys type)
        {
            this.cookieCon = new CookieContainer();
            this.uName = name;
            this.pwd = pwd;
            ...
            builder.Append("&domain=126.com");
            builder.Append("&language=0");
            builder.Append("&bCookie=");
            builder.Append("&username=" + name + "@126.com");
        ...
        private string GetEntryUrl()
        {
            ...
            if (this.en == Address163.Entrys.mail126)
            {
                format = "http://reg.163.com/login.jsp?type=1&product=mail126&url=http://entry.mail.126.com/cgi/ntesdoor?hid%3D10010102%26lightweight%3D1%26verifycookie%3D1%26language%3D0%26style%3D-1";
            }
