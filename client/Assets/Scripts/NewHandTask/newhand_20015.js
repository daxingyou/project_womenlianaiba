...
var arrow_pos1 : Vector2 = Vector2(320, 478);
...
function RegistEvt(){
	...
	EventCenter.RegistHandler(GameEvent.MakeEvent(GameEventDef.REQUEST_WATER), HandleClickWaterBtn);
...
function HandleClickWaterBtn(evt : GameEvent, obj : Object){
	UI.getUI().CloseNewGuideLeadRoot();
}
...
function UnRegistEvt(){
	...
	EventCenter.UnregistHandler(GameEvent.MakeEvent(GameEventDef.REQUEST_WATER), HandleClickWaterBtn);
