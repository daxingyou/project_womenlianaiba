...
namespace Logic.Command
{
    public class ItemCommand : CommandBase
    {
        ...
        public override string GetCommand()
        {
            ...
            string commandContent = "{open_dialog_by_item, " + optionDialogInfo.TemplateId + ", [" + commandList + "]}";
        ...
        private string GetCommandList()
        {
            ...
            {
                stringBuilder.Append("{" + optionDialogInfo.OptionList[i].TemplateId + ", " + this.UniqueId.ToString() + ", " + (PageIndex + 1).ToString() + ", " + (i + 1).ToString() + "}");
